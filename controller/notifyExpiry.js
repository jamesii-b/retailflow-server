mailData = `<center><h1>Cavetown Mart</h1></center><h3>Hi Admin,</h3><br /><div>  This is to inform you that products are expired and expiring.  Please check the inventory and update the inventory accordingly. We have  attached below the items that expired and expiring.</div><br />Regards, <br />System Admin <br />James B. <br /><br /><br /><br /><center><h1>Inventory</h1></center><table border="1" style="width: 100%">  <tr>  <th>Product ID</th>  <th>Item Name</th>    <th>Quantity</th><th>Expiry Date</th>`;
